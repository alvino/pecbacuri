...
from .forms import AnimalForm, TratamentoForm, ReproducaoForm, PastoForm, PesagemForm, PesagemForm, MovimentacaoPastoForm, PesagemModelForm
...
# -------------------------------------
# Logoutica de Identificação de Animais em Risco
# ------------------------------------- 

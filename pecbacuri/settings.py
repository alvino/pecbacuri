...
MESSAGE_TAGS = {
    ...
    messages.INFO: 'info',
    messages.SUCCESS: 'success', # Mapeia 'success' do Django para 'success' do Bootstrap
    messages.WARNING: 'warning',
    messages.ERROR: 'danger',    # Mapeia 'error' do Django para 'danger' (vermelho)
}
...
SECRET_KEY = 'django-insecure-^%%fo-cy7xf&iufsby0o1-ayd8mml!r7+^p0m+8(ze_3hjpd!+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Mude isso em seu settings.py
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'pecbacuri.onrender.com',
    '.onrender.com'  # O ponto no início aceita qualquer subdomínio do Render
]
